      ...
      <Container className="raid-content">
        ...
        <div className="raid-guide">
          ...
          <div className="guide-tips">
            <h5>💡 팁</h5>
            <ul>
              <li>화속성 보스는 우천 및 기상할증 적용 시 데미지 2배가 적용됩니다.</li>
              <li>참여 유저와 레이드 난이도를 고려해 기간 내 데미지 2배 버프가 적용될 수 있습니다.</li>
              <li>랭킹 및 보스 HP는 다음 날 새벽 업데이트 됩니다.</li>
              <li>픽업지 주소에 따라 구역 보스가 지정됩니다.</li>
